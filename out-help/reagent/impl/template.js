...
var or__4671__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4671__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4671__auto__)){
return or__4671__auto__;
} else {
...
var G__19098 = o;
(G__19098[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
return (function() { 
var G__19099__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__19099 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__19100__i = 0, G__19100__a = new Array(arguments.length -  0);
while (G__19100__i < G__19100__a.length) {G__19100__a[G__19100__i] = arguments[G__19100__i + 0]; ++G__19100__i;}
  args = new cljs.core.IndexedSeq(G__19100__a,0);
} 
return G__19099__delegate.call(this,args);};
G__19099.cljs$lang$maxFixedArity = 0;
G__19099.cljs$lang$applyTo = (function (arglist__19101){
var args = cljs.core.seq(arglist__19101);
return G__19099__delegate(args);
});
...
var old_19102 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_19102))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_19102)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__4659__auto__ = (node === document.activeElement);
if(and__4659__auto__){
var and__4659__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
var G__19105 = jsprops;
(G__19105["defaultValue"] = value);

(G__19105["onChange"] = ((function (G__19105,v,value,on_change){
return (function (p1__19103_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__19103_SHARP_);
});})(G__19105,v,value,on_change))
);
...
var vec__19107 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19107,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19107,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19107,(2),null);
...
var temp__4427__auto__ = (function (){var G__19111 = cljs.core.meta(v);
var G__19111__$1 = (((G__19111 == null))?null:reagent.impl.template.get_key(G__19111));
return G__19111__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__19113_19114 = v;
var G__19113_19115__$1 = (((G__19113_19114 == null))?null:reagent.impl.template.key_from_vec(G__19113_19114));
var G__19113_19116__$2 = (((G__19113_19115__$1 == null))?null:(jsprops["key"] = G__19113_19115__$1));
...
var G__19120 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__19120) : reagent.impl.template.as_element.call(null,G__19120));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__19121 = cljs.core.meta(argv);
var G__19121__$1 = (((G__19121 == null))?null:reagent.impl.template.get_key(G__19121));
return G__19121__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__19122 = (((jsprops == null))?{}:jsprops);
(G__19122["key"] = key);
...
var G__19123 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__19123;
continue;
}
} else {
...
var n__5574__auto___19124 = a.length;
var i_19125 = (0);
while(true){
if((i_19125 < n__5574__auto___19124)){
(a[i_19125] = reagent.impl.template.as_element((a[i_19125])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5574__auto___19127 = a.length;
var i_19128 = (0);
while(true){
if((i_19128 < n__5574__auto___19127)){
var val_19129 = (a[i_19128]);
if((cljs.core.vector_QMARK_(val_19129)) && ((reagent.impl.template.key_from_vec(val_19129) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19128] = reagent.impl.template.as_element(val_19129));

var G__19130 = (i_19128 + (1));
i_19128 = G__19130;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4659__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4659__auto__){
return (ctx["no-key"]);
} else {
return and__4659__auto__;
...
var G__19132 = (cljs.core.count(argv) - first_child);
switch (G__19132) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__19132){
