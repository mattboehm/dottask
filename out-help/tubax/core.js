...
var args17785 = [];
var len__5729__auto___17796 = arguments.length;
var i__5730__auto___17797 = (0);
while(true){
if((i__5730__auto___17797 < len__5729__auto___17796)){
args17785.push((arguments[i__5730__auto___17797]));

var G__17798 = (i__5730__auto___17797 + (1));
i__5730__auto___17797 = G__17798;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args17785.length)].join('')));
...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__17788){
...
var strict = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17789__$1,cljs.core.cst$kw$strict,true);
var trim = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17789__$1,cljs.core.cst$kw$trim,true);
var normalize = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17789__$1,cljs.core.cst$kw$normalize,false);
var lowercase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17789__$1,cljs.core.cst$kw$lowercase,true);
var xmlns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17789__$1,cljs.core.cst$kw$xmlns);
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17789__$1,cljs.core.cst$kw$position,true);
var strict_entities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17789__$1,cljs.core.cst$kw$strict_DASH_entities,false);
...
var document = (function (){var G__17791 = tubax.core.new_document();
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__17791) : cljs.core.atom.call(null,G__17791));
})();
...
parser.onopentag = ((function (parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__17780_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_node_document,p1__17780_SHARP_));
});})(parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__17781_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.close_node_document,p1__17781_SHARP_));
});})(parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__17782_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__17782_SHARP_));
});})(parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
...
parser.onend = ((function (parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
var G__17792 = result;
var G__17793 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$success,tubax.core.format_document((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(document) : cljs.core.deref.call(null,document)))], null);
...
parser.onerror = ((function (parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__17784_SHARP_){
var G__17794 = result;
var G__17795 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,[cljs.core.str(p1__17784_SHARP_)].join('')], null);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__17794,G__17795) : cljs.core.reset_BANG_.call(null,G__17794,G__17795));
});})(parser,document,result,map__17789,map__17789__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;
