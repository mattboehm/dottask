...
var args10260 = [];
var len__5729__auto___10271 = arguments.length;
var i__5730__auto___10272 = (0);
while(true){
if((i__5730__auto___10272 < len__5729__auto___10271)){
args10260.push((arguments[i__5730__auto___10272]));

var G__10273 = (i__5730__auto___10272 + (1));
i__5730__auto___10272 = G__10273;
continue;
} else {
}
break;
...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__10263){
...
var strict = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10264__$1,cljs.core.cst$kw$strict,true);
var trim = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10264__$1,cljs.core.cst$kw$trim,true);
var normalize = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10264__$1,cljs.core.cst$kw$normalize,false);
var lowercase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10264__$1,cljs.core.cst$kw$lowercase,true);
var xmlns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10264__$1,cljs.core.cst$kw$xmlns);
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10264__$1,cljs.core.cst$kw$position,true);
var strict_entities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10264__$1,cljs.core.cst$kw$strict_DASH_entities,false);
...
var document = (function (){var G__10266 = tubax.core.new_document();
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__10266) : cljs.core.atom.call(null,G__10266));
})();
...
parser.onopentag = ((function (parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__10255_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_node_document,p1__10255_SHARP_));
});})(parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__10256_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.close_node_document,p1__10256_SHARP_));
});})(parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__10257_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__10257_SHARP_));
});})(parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__10258_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__10258_SHARP_));
});})(parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onend = ((function (parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
var G__10267 = result;
var G__10268 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$success,tubax.core.format_document((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(document) : cljs.core.deref.call(null,document)))], null);
...
parser.onerror = ((function (parser,document,result,map__10264,map__10264__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__10259_SHARP_){
var G__10269 = result;
var G__10270 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,[cljs.core.str(p1__10259_SHARP_)].join('')], null);
